      ...
      <div className="w-full max-w-md rounded-2xl border border-[var(--border)] bg-white p-8 shadow-lg">
        <div className="mb-6 text-center">
          ...
          <p className="mt-2 text-sm text-[var(--muted)]">
            Sign in with your Pratham Google account to manage legal requests.
          </p>
        </div>
        <button
          type="button"
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-[var(--primary)] px-4 py-3 text-sm font-medium text-white hover:bg-[var(--primary-hover)] disabled:opacity-50"
        >
        ...
        <p className="mt-6 text-center text-xs text-[var(--muted)]">
          Access is limited to authorized legal team members.
        </p>
      </div>
    </div>
  );
